...
uploads = [
    ...
    ("public/assets/images/aiia-header-brand.png", "aiia-header-brand.png"),
    ("public/assets/images/aiia-header-logo.png", "aiia-header-logo.png"),
]
...
PUB="{pub}"
UP="{remote_up}"
mkdir -p "$APP/public/assets/images" "$PUB/assets/images"
...
cp "$UP/aiia-header-brand.png" "$APP/public/assets/images/aiia-header-brand.png"
cp "$UP/aiia-header-brand.png" "$PUB/assets/images/aiia-header-brand.png"
cp "$UP/aiia-header-logo.png" "$APP/public/assets/images/aiia-header-logo.png"
cp "$UP/aiia-header-logo.png" "$PUB/assets/images/aiia-header-logo.png"
cd "$APP"
...
script_path = os.path.join(base, "_deploy_header_undo.sh")
...
subprocess.run(["scp", "-i", key, "-o", "StrictHostKeyChecking=accept-new", script_path, f"{host}:{remote_up}/deploy_header_undo.sh"], check=True)
r2 = subprocess.run(["ssh", "-i", key, host, f"bash {remote_up}/deploy_header_undo.sh"], capture_output=True, text=True, timeout=180)
print(r2.stdout)
print(r2.stderr)
