...
pairs = [
    ...
    ("app/Http/Controllers/Concerns/HandlesBulkSelection.php", "HandlesBulkSelection.php"),
    ...
    ("app/Exports/PatientsListExport.php", "PatientsListExport.php"),
    ("app/Exports/ContactsExport.php", "ContactsExport.php"),
    ("app/Exports/CurePatientsExport.php", "CurePatientsExport.php"),
    ("app/Exports/ResearchPatientsExport.php", "ResearchPatientsExport.php"),
    ("app/Exports/IdCardsExport.php", "IdCardsExport.php"),
...
script_path = os.path.join(base, "_deploy_bulk_actions.sh")
...
subprocess.run(
    ["scp", "-i", key, "-o", "StrictHostKeyChecking=accept-new", script_path, f"{host}:{remote_up}/deploy_bulk_actions.sh"],
    check=True,
)
r2 = subprocess.run(
    ["ssh", "-i", key, host, f"bash {remote_up}/deploy_bulk_actions.sh"],
    capture_output=True,
    text=True,
    timeout=300000,
)
